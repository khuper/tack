...
export function printHandoffPlain(markdownPath: string, jsonPath: string, generatedAt: string): void {
  ...
  console.log("");
  console.log("Give this to your agent: attach the .md file to your chat (or add it to context in Cursor). For structured use, start with tack://context/start_here, then use tack://handoff/latest (MCP).");
}
